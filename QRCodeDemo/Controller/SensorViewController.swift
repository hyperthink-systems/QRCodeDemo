    ...
    @objc func update() {
        if let accelerometerData = motion.accelerometerData {
            DispatchQueue.main.async {
                ...
                accXArray.append(self.roundDouble(value: accelerometerData.acceleration.x))
                accYArray.append(self.roundDouble(value: accelerometerData.acceleration.y))
                accZArray.append(self.roundDouble(value: accelerometerData.acceleration.z))
        ...
        if let magnetoMeter = motion.magnetometerData {
            ...
            DispatchQueue.main.async {
                ...
                magXArray.append(self.roundDouble(value: magnetoMeter.magneticField.x))
                magYArray.append(self.roundDouble(value: magnetoMeter.magneticField.y))
                magZArray.append(self.roundDouble(value: magnetoMeter.magneticField.z))
